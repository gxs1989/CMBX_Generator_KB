...
| CM_MethodScriptMdSpec | 2.2 | 2026-07-17 | Strict web-AI MD authoring and Method Script Generator preflight contract | Published | `cmbx_data_explorer/docs/CM_METHOD_SCRIPT_MD_FORMAT_SPEC.md`, `C:\ProgramData\CMBX Data Explorer Workspace\KB\Method Script Generator\Generator Spec\CM_METHOD_SCRIPT_MD_FORMAT_SPEC.md` |
